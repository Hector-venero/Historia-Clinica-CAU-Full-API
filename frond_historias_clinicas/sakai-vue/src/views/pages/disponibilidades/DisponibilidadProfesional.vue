<template>
  <div class="p-10 max-w-6xl mx-auto">
    <div class="bg-white shadow-2xl rounded-2xl p-10 border border-gray-100 scale-[1.02] transition-all">
      <div class="flex items-center justify-between mb-10">
        <div>
          ...
          <p class="text-gray-500 text-lg">
            Configurá tus días y horarios de atención. Podés activar o desactivar los días según tu agenda.
          </p>
        </div>
      </div>
      ...
      <div class="overflow-x-auto mt-6">
        <table class="min-w-full border border-gray-200 rounded-2xl shadow-sm text-base">
          <thead class="bg-gradient-to-r from-blue-50 to-blue-100 text-gray-700">
            <tr>
              <th class="text-left px-6 py-4 border-b font-semibold">Día</th>
              <th class="text-center px-6 py-4 border-b font-semibold">Activo</th>
              <th class="text-center px-6 py-4 border-b font-semibold">Hora inicio</th>
              <th class="text-center px-6 py-4 border-b font-semibold">Hora fin</th>
            </tr>
          </thead>
          <tbody>
            <tr
              ...
              :key="dia.nombre"
              class="transition-all hover:bg-blue-50"
            >
              <td class="px-6 py-4 border-b font-medium text-gray-800 text-lg">{{ dia.nombre }}</td>
              <td class="text-center border-b">
                <label class="relative inline-flex items-center cursor-pointer">
                  <input type="checkbox" v-model="dia.activo" class="sr-only peer" />
                  <div
                    class="w-12 h-6 bg-gray-300 rounded-full peer peer-checked:bg-blue-500 transition"
                  ></div>
                  <span
                    class="absolute left-1 top-1 bg-white w-4 h-4 rounded-full shadow transform transition peer-checked:translate-x-6"
                  ></span>
                </label>
              </td>
              <td class="text-center border-b">
                <input
                  ...
                  :disabled="!dia.activo"
                  class="border border-gray-300 rounded-lg px-3 py-2 text-base w-32 focus:ring-2 focus:ring-blue-400 disabled:opacity-50"
                />
              </td>
              <td class="text-center border-b">
                <input
      ...
      <div class="flex justify-end mt-10 space-x-4">
        <button
          ...
          class="bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium px-6 py-3 rounded-lg border border-gray-300 shadow-sm transition text-base"
        >
          🔄 Recargar
        </button>
        <button
