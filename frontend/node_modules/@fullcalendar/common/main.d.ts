...
import { Ref, ComponentChildren, createElement, Context, RefObject, ComponentType, VNode, Component, VUIEvent } from '@fullcalendar/common/vdom';
export * from '@fullcalendar/common/vdom';
export { VUIEvent } from '@fullcalendar/common/vdom';
...
declare type MemoiseArrayFunc<Args extends any[], Res> = (argSets: Args[]) => Res[];
...
declare type MemoizeHashFunc<Args extends any[], Res> = (argHash: {
    [key: string]: Args;
}) => {
    [key: string]: Res;
};
